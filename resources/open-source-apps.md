...
- [**CC Switch**](https://github.com/farion1231/cc-switch) —— 跨平台桌面 AI 工具管理助手，支持 Claude Code、Codex、OpenCode 等多种 AI 工具的统一管理
- [**OpenCode**](https://github.com/anomalyco/opencode) —— 开源编码代理，支持多种 AI 模型，可自托管，相比 Claude Code 更灵活且免费，避免接入第三方api被注入恶意prompt破坏缓存

---

## 效率
- **Obsidian** —— 本地优先的双链笔记（免费但不开源）,可以很好的和大模型协作，提高效率
...
- [**Bitwarden**](https://github.com/bitwarden/clients) —— 全平台密码管理器，支持浏览器扩展和移动端，可自建服务器
- [**Keyguard**](https://github.com/AChep/keyguard) —— Bitwarden 的第三方 Android 客户端，UI更简洁好用
- [**KeePassXC**](https://github.com/keepassxreboot/keepassxc) —— 本地存储密码，数据完全掌控在自己手中
...
- [**Shadowrocket**](https://www.shadowrocket.vip) —— iOS 平台的代理客户端（非开源，付费，需在非国区App Store 购买，还有很多类似的软件）
...
## 生活
- [**996.ICU**](https://github.com/996icu/996.ICU) —— 关于中国科技行业996工作制的抗议项目，倡导劳动权益保护
